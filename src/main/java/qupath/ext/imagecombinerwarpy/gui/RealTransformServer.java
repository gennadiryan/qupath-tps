...
public class RealTransformServer extends AbstractTransformServer<InvertibleRealTransform> {
    private ImageRegion region;
    private InvertibleRealTransform transform;
    private InvertibleRealTransform transformInverse;

    public RealTransformServer(final ImageServer<BufferedImage> server, InvertibleRealTransform transform) {
    ...
    @Override protected AbstractTransformServer<InvertibleRealTransform>.AbstractTransformServerBuilder<InvertibleRealTransform> createServerBuilder() {
				return new AbstractTransformServer<InvertibleRealTransform>.AbstractTransformServerBuilder<InvertibleRealTransform>(this.getMetadata(), this.getWrappedServer().getBuilder(), this.getTransform()) {
						@Override protected AbstractTransformServer<InvertibleRealTransform> buildOriginal() throws Exception {
