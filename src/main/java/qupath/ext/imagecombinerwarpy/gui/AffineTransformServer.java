...
public class AffineTransformServer extends AbstractTransformServer<AffineTransform> {
    private ImageRegion region;
    private AffineTransform transform;
    private AffineTransform transformInverse;

    public AffineTransformServer(final ImageServer<BufferedImage> server, AffineTransform transform) throws NoninvertibleTransformException {
      	super(server, new AffineTransform(transform));

      	this.transformInverse = this.getTransform().createInverse();
